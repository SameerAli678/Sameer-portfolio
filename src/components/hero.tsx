    ...
    <div className="bg-primary flex flex-col justify-between rounded-b-[20px] p-10 min-h-[600px]">
      ...
      <div className="flex flex-col gap-4">
        <h1 className="text-white text-4xl md:text-6xl lg:text-8xl font-medium">
          I craft{" "}
          <span className="italic pr-2 sm:min-w-[300px] lg:min-w-[500px] bg-text-gradient pb-1 inline-block text-transparent bg-clip-text">
            {/* Memorable */}
            <TextAnimation
              text={[
                "memorable",
      ...
      <div className="flex gap-4 justify-between items-end">
        ...
        <Link href="#about">
          <Image alt="" src="/icons/scroll-down.svg" width={106} height={106} />
        </Link>
      </div>
    </div>
  );
