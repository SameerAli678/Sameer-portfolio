  ...
  return (
    ...
    >
      ...
      <p data-aos="zoom-out-left">
        ...
        life through modern, responsive, and intuitive interfaces. Whether
        it&#39;s a portfolio, landing page, or full website, I focus on creating
        seamless experiences that not only look great but also feel great to
        use.
      </p>
    </div>
  );
